...
8. The source code in main.py regularly records an audio stream over I2S. To check whether the microphone is working, logging of the audio stream can be performed by setting a variable in recorder.py. 
